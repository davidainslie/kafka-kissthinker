...
class EmbeddedKafka4Spec(implicit ev: ExecutionEnv) extends Specification {
  "Embedded Kafka" should {
    "have message published and a subscription of said message" in new EmbeddedKafka {
    ...
    /*"have message published and a subscription fail" in new EmbeddedKafka {
